...
if [ -d ${i}_denovo_merge6 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_denovo_merge6..."
folder=${i}_denovo_merge6
cd ${i}_denovo_merge6
else
echo "${i}_denovo_merge6 doesn't exist.  Creating..."
mkdir ${i}_denovo_merge6
folder=${i}_denovo_merge6
cd ${i}_denovo_merge6
fi # if dir check
