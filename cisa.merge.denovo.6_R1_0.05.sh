...
if [ -d ${i}_merge6_R2_0.05 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.05..."
folder=${i}_merge6_R2_0.05
cd ${i}_merge6_R2_0.05
else
echo "${i}_merge6_R2_0.05 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.05
folder=${i}_merge6_R2_0.05
cd ${i}_merge6_R2_0.05
fi # if dir check
...
echo "R2_Gap=0.05" >>$folder.CISA.denovo.config
