...
if [ -d ${i}_merge6_R2_0.55 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.55..."
folder=${i}_merge6_R2_0.55
cd ${i}_merge6_R2_0.55
else
echo "${i}_merge6_R2_0.55 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.55
folder=${i}_merge6_R2_0.55
cd ${i}_merge6_R2_0.55
fi # if dir check
...
echo "R2_Gap=0.55" >>$folder.CISA.denovo.config
