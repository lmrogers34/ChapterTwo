...
perl /home/lrogers/work/deNovo-stats/assembly/paired/contig.truncator.pl -i ${i}.denovo.merge.cisa.fa -l 500 -o ${i}.denovo.merge.cisa.fa.truncated.fa
...
then
	...
	then
		...
		then
			...
			samtools sort ${i}_same_map.bam ${i}_same_map.sorted
			#7 Reapr pipeline
