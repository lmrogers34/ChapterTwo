...
if [ -d ${i}_merge6_R2_0.35 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.35..."
folder=${i}_merge6_R2_0.35
cd ${i}_merge6_R2_0.35
else
echo "${i}_merge6_R2_0.35 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.35
folder=${i}_merge6_R2_0.35
cd ${i}_merge6_R2_0.35
fi # if dir check
...
echo "R2_Gap=0.35" >>$folder.CISA.denovo.config
