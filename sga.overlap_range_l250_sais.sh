...
sga preprocess --pe-mode 1 -o reads.pp.fastq /home/lrogers/work/deNovo-stats/Reads/Simulated/Paired/${i}_1.fq /home/lrogers/work/deNovo-stats/Reads/Simulated/Paired/${i}_2.fq
# Error Correction
...
sga index -a sais -t 8 --no-reverse reads.pp.fastq
...
sga index -a sais -t 8 reads.ec.fastq
