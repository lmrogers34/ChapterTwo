...
if [ -d ${i}_merge6_R2_0.75 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.75..."
folder=${i}_merge6_R2_0.75
cd ${i}_merge6_R2_0.75
else
echo "${i}_merge6_R2_0.75 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.75
folder=${i}_merge6_R2_0.75
cd ${i}_merge6_R2_0.75
fi # if dir check
...
echo "R2_Gap=0.75" >>$folder.CISA.denovo.config
