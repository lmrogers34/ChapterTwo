...
if [ -d ${i}_merge6_R2_0.25 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.25..."
folder=${i}_merge6_R2_0.25
cd ${i}_merge6_R2_0.25
else
echo "${i}_merge6_R2_0.25 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.25
folder=${i}_merge6_R2_0.25
cd ${i}_merge6_R2_0.25
fi # if dir check
...
echo "R2_Gap=0.25" >>$folder.CISA.denovo.config
