...
if [ -d ${i}_merge6_R2_0.85 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.85..."
folder=${i}_merge6_R2_0.85
cd ${i}_merge6_R2_0.85
else
echo "${i}_merge6_R2_0.85 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.85
folder=${i}_merge6_R2_0.85
cd ${i}_merge6_R2_0.85
fi # if dir check
...
echo "R2_Gap=0.85" >>$folder.CISA.denovo.config
