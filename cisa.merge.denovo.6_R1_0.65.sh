...
if [ -d ${i}_merge6_R2_0.65 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.65..."
folder=${i}_merge6_R2_0.65
cd ${i}_merge6_R2_0.65
else
echo "${i}_merge6_R2_0.65 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.65
folder=${i}_merge6_R2_0.65
cd ${i}_merge6_R2_0.65
fi # if dir check
...
echo "R2_Gap=0.65" >>$folder.CISA.denovo.config
