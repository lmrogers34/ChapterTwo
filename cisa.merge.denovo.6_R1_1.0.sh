...
if [ -d ${i}_merge6_R2_1.0 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_1.0..."
folder=${i}_merge6
cd ${i}_merge6_R2_1.0
else
echo "${i}_merge6_R2_1.0 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_1.0
folder=${i}_merge6
cd ${i}_merge6_R2_1.0
fi # if dir check
...
echo "R2_Gap=1.0" >>$folder.CISA.denovo.config
