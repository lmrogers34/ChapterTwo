...
if [ -d ${i}_merge6_R2_0.15 ] # if it is a dir ( -d checks if $i is a dir)
then
echo "Changing to ${i}_merge6_R2_0.15..."
folder=${i}_merge6_R2_0.15
cd ${i}_merge6_R2_0.15
else
echo "${i}_merge6_R2_0.15 doesn't exist.  Creating..."
mkdir ${i}_merge6_R2_0.15
folder=${i}_merge6_R2_0.15
cd ${i}_merge6_R2_0.15
fi # if dir check
...
echo "R2_Gap=0.15" >>$folder.CISA.denovo.config
